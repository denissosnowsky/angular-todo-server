    ...
    async changePassword(userEmail, oldPass, newPass) {
        ...
        try {
            ...
            if (validatedUser &&
                ...
                await this.mailService.sendPasswordChangeConfirmation(validatedUser.email, `${this.configService.get('API_URL')}/users/passConfirm/${validatedUser.activationLink}`);
                return undefined;
            }
